...
namespace DataProtectionTest.Controllers
{
    public class BooksController : Controller
    {
        private readonly BookListRazorContext _context;
        private readonly IDataProtector _dataProtector;

        public BooksController(BookListRazorContext context, IDataProtectionProvider dataProtectorProvider)
        {
            _context = context;
            _dataProtector = dataProtectorProvider.CreateProtector("BooksController");
        }
